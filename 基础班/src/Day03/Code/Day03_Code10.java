...
public class Day03_Code10 {
    ...
    private int loop() {
        ...
        while (true) {
            // 提示用户输入数字
            System.out.println("请输入1到7之间的一个整数：");
            System.out.println("输入0退出选择");
            // 键盘录入
    ...
    public static void main(String[] args) {
        ...
        Day03_Code10 day03_Code10 = new Day03_Code10();
        num = day03_Code10.loop();
        day03_Code10.weekdays(num);
