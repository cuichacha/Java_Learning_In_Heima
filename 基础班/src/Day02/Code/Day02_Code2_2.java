...
public class Day02_Code2_2 {

    public static void main(String[] args) {
        double num1;
        double num2;

        Day02_Code2_2 day02_Code2_2 = new Day02_Code2_2();
        num1 = day02_Code2_2.loop(1);
        num2 = day02_Code2_2.loop(2);
        day02_Code2_2.sum(num1,num2);
    }
    ...
    private void sum(double num1, double num2) {
        ...
        if (sum1 == (int) sum1) {
            sum2 = (int) sum1;
            System.out.println("数字1与数字2的和为：" + sum2);
        } else {
            System.out.println("数字1与数字2的和为：" + sum1);
        }
    }
}
