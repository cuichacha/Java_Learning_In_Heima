...
public class Day02_HW1 {
    ...
    public static void main(String[] args) {
        ...
        Day02_HW1 day02_HW1 = new Day02_HW1();

        num1 = day02_HW1.loop(1);
        num2 = day02_HW1.loop(2);
        num3 = day02_HW1.loop(3);
        day02_HW1.comparison(num1, num2, num3);
    ...
    private void comparison(double num1, double num2, double num3) {
        ...
        if (max == (int) (max)) {
            maximum = (int) max;
            System.out.println("三个和尚中最高者的身高为： " + maximum);
        } else {
            System.out.println("三个和尚中最高者的身高为： " + max);
        }
    ...
    private double loop(int i) {
        ...
        while (true) {
            // 提示用户输入数字
            System.out.println("请输入和尚" + i + "的身高：");
            // 键盘录入
