...
public class Day02_HW3 {
    ...
    private void dividedByFive(int num) {
        if (num % 5 == 0) {
            System.out.println("数字" + num + "是5的"+ (num / 5) +"倍");
        } else {
            System.out.println("数字" + num + "不是5的整数倍");
        }
    }
    ...
    public static void main(String[] args) {
        ...
        Day02_HW3 day02_HW3 = new Day02_HW3();
        num = day02_HW3.loop();
        day02_HW3.dividedByFive(num);
    }
}
